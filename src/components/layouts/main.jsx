                        ...
                        {showFilter && (
                            <div className="bg-white w-full p-3 text-gray-700">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        <input type="date" min="1984-03-11" value="1984-03-11" className={`${classes.datePicker} ml-3`} />
                                        <input type="date" min="1984-03-11" value="1984-03-11" className={classes.datePicker} />
                                    </div>
                                </div>
                            </div>
                        )}
