...
const Dialog = ({children, open, width}) => {
    ...
    return (
        <>
            {showWrapper && (
                <div className={`fixed z-50 top-0 bottom-0 left-0 right-0 flex justify-center transition-all ease-in-out duration-100 ${open ? 'bg-gray-900/60 backdrop-blur-lg' : 'bg-transparent'}`}>
